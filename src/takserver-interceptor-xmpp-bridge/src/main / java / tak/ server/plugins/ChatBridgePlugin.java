...
public class ChatBridgePlugin extends MessageInterceptorBase {
    ...
    public ChatBridgePlugin() {
        ...
        logger.info("ChatBridgePlugin initialized with config: xmppHost={}, xmppUser={}, xmppRecipient={}, xmppPort={}",
                xmppHost, xmppUser, xmppRecipient, xmppPort);
    }
        ...
        try {
            ...
            if (cotXml.contains("<__chat") || cotXml.contains("<chat")) {
                ...
                if (chatText != null && callsign != null) {
                    if (logChatContents) {
                        logger.info("Intercepted chat message from {}: {}", callsign, chatText);
                    } else {
                        logger.info("Intercepted chat message from {}", callsign);
                    }
